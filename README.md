# 蜉蝣罗塔丝 · 创作工坊 / VIRTUALOTUS CREATE STUDIO

> **内测版本 · 不公开（Private / Closed Beta）｜ 仅限受邀成员访问**

本仓库为「蜉蝣罗塔丝」塔罗牌参数化创作系统的内部测试版本，内容不对外公开，邀请制访问。
...
- 内测（closed beta），不对外公开
- 邀请制：由作者手动添加协作者（Settings → Collaborators）后方可访问
